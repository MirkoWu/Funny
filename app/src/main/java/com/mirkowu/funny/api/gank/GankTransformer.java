 ...
 */
public class GankTransformer<T> implements ObservableTransformer<GankBaseBean<T>, T> {
    private IBaseDisplay mView;
    private boolean showLoading;

    public GankTransformer(IBaseDisplay mView) {
        this(mView, true);
    }

    public GankTransformer(IBaseDisplay mView, boolean showLoading) {
