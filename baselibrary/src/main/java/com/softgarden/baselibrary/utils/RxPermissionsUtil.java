...
public class RxPermissionsUtil {
    ...
    public static void check(final Activity activity, final String[] permissions,
                             final String title, final String content, /*final String cancelText, String ensureText, */
                ...
                .subscribe(new Consumer<Permission>() {
                    ...
                    public void accept(Permission permission) throws Exception {
                        if (permission.granted) {//已获取权限
                            ...
                            showPermissionDialog(activity, title, content, new DialogInterface.OnClickListener() {
                                @Override
                                public void onClick(DialogInterface dialog, int which) {
                                    check(activity, permissions, title,content, listener);
                                }
                            });
                        } else {//被拒绝，弹窗提示
                            showPermissionDialog(activity, title, content, new DialogInterface.OnClickListener() {
